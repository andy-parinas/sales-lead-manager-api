...
class ConstructionActualSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        while (($data = fgetcsv($file)) !== FALSE) {
            ...
            $tradeStaff = TradeStaff::where('legacy_name', $tradeStaffData)->first();
            ...
            if($franchise != null){
                ...
                $lead = Lead::where('reference_number', $leadNumber)
                ...
                if($lead != null){
                    ...
                    $constructionData = [
                        ...
                        'trade_staff_id' => $tradeStaff != null? $tradeStaff->id : null,
